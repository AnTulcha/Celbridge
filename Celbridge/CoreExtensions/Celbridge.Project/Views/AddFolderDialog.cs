...
public sealed partial class AddFolderDialog : ContentDialog, INewProjectDialog
{
    private IStringLocalizer _stringLocalizer;

    public AddFolderDialogViewModel ViewModel { get; }
    ...
    public AddFolderDialog()
    {
        ...
        ViewModel = serviceProvider.GetRequiredService<AddFolderDialogViewModel>();
