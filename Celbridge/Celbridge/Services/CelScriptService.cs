...
namespace Celbridge.Services
{
    public interface ICelScriptService
    {
        ...
        Task<Result> StartApplication(string projectFolder, string libraryFolder, string chatAPIKey);
    }
    ...
    public class CelScriptService : ICelScriptService
    {
        ...
        public async Task<Result> StartApplication(string projectFolder, string libraryPath, string chatAPIKey)
        {
            ...
            var runResult = await celApplicationTask.Run(projectFolder, print, chatAPIKey);
