...
{
    public partial class ExpressionPropertyView : UserControl, IPropertyView
    {
        public ExpressionPropertyViewModel ViewModel { get; }

        public ExpressionPropertyView()
        {
            this.InitializeComponent();

            var services = (Application.Current as App).Host.Services;
            ViewModel = services.GetRequiredService<ExpressionPropertyViewModel>();
        }
